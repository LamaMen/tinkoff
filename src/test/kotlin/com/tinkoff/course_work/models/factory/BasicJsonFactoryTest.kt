...
class BasicJsonFactoryTest {
    ...
    fun `build coast by transaction without id`() {
        val transaction = BaseTransaction(null, "transaction", 10, LocalDateTime.now(), true, Category.Other, "EUR")
    ...
    fun `build coast by transaction with id`() {
        val transaction = BaseTransaction(1, "transaction", 10, LocalDateTime.now(), true, Category.Other, "EUR")
        val coast = factory.build<Coast>(transaction)
    ...
    fun `build income by transaction without id`() {
        val transaction = BaseTransaction(null, "transaction", 10, LocalDateTime.now(), false, Category.Other, "EUR")
    ...
    fun `build income by transaction with id`() {
        val transaction = BaseTransaction(1, "transaction", 10, LocalDateTime.now(), false, Category.Other, "EUR")
        val income = factory.build<Income>(transaction)
